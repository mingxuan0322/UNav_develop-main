...
def option():
    ...
    parser.add_argument('--cpu_num', type=int, default=cpu_count())
...
def best_pairs(global_feature_path, feature_path,match_output_path, yaw_seq=None, GT_path=None, GT_thre=None, max_try=None,
               num_seq=False,cpu_num=cpu_count(),min_match_score=0.85, min_valid_ratio=0.09,num_match_required=10,batch_size=0,pair_file_path=None):
...
if __name__ == '__main__':
    ...
    best_pairs(args.global_feature_path, args.feature_path,args.match_output_path, yaw_seq=args.yaw_seq, GT_path=args.GT_path,
                         GT_thre=args.GT_thre, max_try=args.max_try, num_seq=args.num_seq,cpu_num=args.cpu_num,min_match_score=args.min_match_score, min_valid_ratio=args.min_valid_ratio,
